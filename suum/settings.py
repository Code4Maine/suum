"""
Django settings for our suum project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'suum/apps'))
    ...
    ROOT_URLCONF = 'suum.urls'

    WSGI_APPLICATION = 'suum.wsgi.application'
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "suum/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "suum/static"),
    )
